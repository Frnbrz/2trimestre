...
const TutorialsList = () => {
  const [tutorials, setTutorials] = useState([] as TutorialModel[])
  const [currentTutorial, setCurrentTutorial] = useState(null as TutorialModel | null)
  ...
  const setActiveTutorial = (tutorial: TutorialModel, index: number) => {
